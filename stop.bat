...
powershell -NoProfile -ExecutionPolicy Bypass -Command "try { Invoke-RestMethod -Method Post -TimeoutSec 5 http://127.0.0.1:8000/api/app/shutdown | Out-Null; exit 0 } catch { exit 1 }" >nul 2>nul
