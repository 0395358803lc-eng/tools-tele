...
Copy-Item (Join-Path $Root "RESTORE_BACKUP.bat") (Join-Path $Target "RESTORE_BACKUP.bat")
Copy-Item (Join-Path $Root "SOAK_TEST.bat") (Join-Path $Target "SOAK_TEST.bat")
Copy-Item (Join-Path $Root "soak_test.ps1") (Join-Path $Target "soak_test.ps1")
